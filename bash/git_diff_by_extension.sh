...
# 用法: ./git_flatten_diff.sh <commit1> <commit2> [output_dir]
...
for file in $files; do
    # 将路径中的/替换为__作为文件名
    safe_filename=$(echo "$file" | sed 's/\//__/g')
...
{
    echo "Git Flattened Diff Summary"
    echo "========================="
...
echo "Flat structure with full path in filenames"
